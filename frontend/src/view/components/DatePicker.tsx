  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: 'flex gap-1',
        nav_button_previous: 'text-teal-800 flex items-center justify-center cursor-pointer !bg-transparent',
        nav_button_next: 'text-teal-800 flex items-center justify-center cursor-pointer !bg-transparent',
